...
class Ui_ProductDialog(object):
    def setupUi(self, ProductDialog):
        ...
        self.ChooseFile = QPushButton(ProductDialog)
        ...
        self.gridLayout.addWidget(self.Name, 4, 2, 1, 1)

        self.Description = QLineEdit(ProductDialog)
        self.Description.setObjectName(u"Description")

        self.gridLayout.addWidget(self.Description, 6, 2, 1, 1)
        ...
        self.Price = QDoubleSpinBox(ProductDialog)
        self.Price.setObjectName(u"Price")
        self.Price.setMaximum(2000000000.000000000000000)
    ...
    def retranslateUi(self, ProductDialog):
        ...
        self.label_2.setText(QCoreApplication.translate("ProductDialog", u"\u041a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u044f", None))
        self.label_3.setText(QCoreApplication.translate("ProductDialog", u"\u041d\u0430\u0438\u043c\u0435\u043d\u043e\u0432\u0430\u043d\u0438\u0435", None))
        self.label.setText(QCoreApplication.translate("ProductDialog", u"\u0410\u0440\u0442\u0438\u043a\u0443\u043b", None))
        self.Image.setText("")
        self.ChooseFile.setText(QCoreApplication.translate("ProductDialog", u"\u0412\u0431\u044b\u0440\u0430\u0442\u044c \u0444\u0430\u0439\u043b", None))
